 ...
 * @author ALLY BITEBO
 *
 *This action adds an external audio to a node
 */
@EnabledAction(checkOnNodeChange = true)
public class AddExternalAudioAction extends AFreeplaneAction {
	private static final long serialVersionUID = 1L;

	public AddExternalAudioAction() {
		super("ExternalAudioAddAction");
	}
